...
public class Blocks {
    ...
    public static void registerBlocks() {
        ...
        DEEPSLATE_BAUXITE_ORE = Registry.register(Registry.BLOCK, new Identifier(Reference.MOD_ID, "deepslate_bauxite_ore"), new Block(FabricBlockSettings.copy(Blocks.BAUXITE_ORE)));
        DEEPSLATE_LEAD_ORE = Registry.register(Registry.BLOCK, new Identifier(Reference.MOD_ID, "deepslate_lead_ore"), new Block(FabricBlockSettings.copy(Blocks.LEAD_ORE)));
        DEEPSLATE_LITHIUM_ORE = Registry.register(Registry.BLOCK, new Identifier(Reference.MOD_ID, "deepslate_lithium_ore"), new Block(FabricBlockSettings.copy(Blocks.LITHIUM_ORE)));
        DEEPSLATE_PLATINUM_ORE = Registry.register(Registry.BLOCK, new Identifier(Reference.MOD_ID, "deepslate_platinum_ore"), new Block(FabricBlockSettings.copy(Blocks.PLATINUM_ORE)));
        DEEPSLATE_RUBY_ORE = Registry.register(Registry.BLOCK, new Identifier(Reference.MOD_ID, "deepslate_ruby_ore"), new Block(FabricBlockSettings.copy(Blocks.RUBY_ORE)));
        DEEPSLATE_SAPPHIRE_ORE = Registry.register(Registry.BLOCK, new Identifier(Reference.MOD_ID, "deepslate_sapphire_ore"), new Block(FabricBlockSettings.copy(Blocks.SAPPHIRE_ORE)));
        DEEPSLATE_SILVER_ORE = Registry.register(Registry.BLOCK, new Identifier(Reference.MOD_ID, "deepslate_silver_ore"), new Block(FabricBlockSettings.copy(Blocks.SILVER_ORE)));
        DEEPSLATE_TIN_ORE = Registry.register(Registry.BLOCK, new Identifier(Reference.MOD_ID, "deepslate_tin_ore"), new Block(FabricBlockSettings.copy(Blocks.TIN_ORE)));
        DEEPSLATE_URANIUM_ORE = Registry.register(Registry.BLOCK, new Identifier(Reference.MOD_ID, "deepslate_uranium_ore"), new Block(FabricBlockSettings.copy(Blocks.URANIUM_ORE)));

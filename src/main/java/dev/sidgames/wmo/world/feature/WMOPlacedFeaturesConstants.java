...
public class WMOPlacedFeaturesConstants {
    ...
    public static final RegistryEntry<PlacedFeature> ENDERITE_ORE_PLACED = PlacedFeatures.register("enderite_ore_placed", WMOConfiguredFeaturesHelper.ENDERITE_ORE, WMOOreFeaturesHelper.modifiersWithCount(1, HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(-64), YOffset.aboveBottom(80))));
    ...
    public static final RegistryEntry<PlacedFeature> COBALT_ORE_PLACED = PlacedFeatures.register("cobalt_ore_placed", WMOConfiguredFeaturesHelper.COBALT_ORE, WMOOreFeaturesHelper.modifiersWithCount(8, HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(-80), YOffset.aboveBottom(100))));
    public static final RegistryEntry<PlacedFeature> ZINC_ORE_PLACED = PlacedFeatures.register("zinc_ore_placed", WMOConfiguredFeaturesHelper.ZINC_ORE, WMOOreFeaturesHelper.modifiersWithCount(8, HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(-80), YOffset.aboveBottom(100))));
    public static final RegistryEntry<PlacedFeature> TITANIUM_ORE_PLACED = PlacedFeatures.register("titanium_ore_placed", WMOConfiguredFeaturesHelper.TITANIUM_ORE, WMOOreFeaturesHelper.modifiersWithCount(8, HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(-80), YOffset.aboveBottom(100))));
}

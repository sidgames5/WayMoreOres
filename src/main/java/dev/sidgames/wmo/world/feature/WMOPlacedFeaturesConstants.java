...
public class WMOPlacedFeaturesConstants {
    ...
    public static final RegistryEntry<PlacedFeature> ENDERITE_ORE_PLACED = PlacedFeatures.register("enderite_ore_placed", WMOConfiguredFeaturesHelper.ENDERITE_ORE, WMOOreFeaturesHelper.modifiersWithCount(16, HeightRangePlacementModifier.trapezoid(YOffset.aboveBottom(-64), YOffset.aboveBottom(80))));
